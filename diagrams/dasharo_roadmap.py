...
pcengines = roadmap.add_group(
    "PC Engines apu2/3/4/6 coreboot+UEFI v0.9.0", font_size=26
)
...
pcengines_091.add_task(
    "DES Release", "2024-10-01", "2024-12-31", style="rounded", fill_colour="#FD7E14"
)
pcengines_24050001.add_task(
    "DES Release", "2024-04-01", "2024-06-30", style="rounded", fill_colour="#FD7E14"
)
pcengines_24080001.add_task(
    "DES Release", "2024-07-01", "2024-09-30", style="rounded", fill_colour="#FD7E14"
)
pcengines_4034.add_task(
    "DES Release", "2024-10-01", "2024-12-31", style="rounded", fill_colour="#FD7E14"
)
...
protectli.add_task(
    "Porting", "2024-02-15", "2024-09-30", style="rounded", fill_colour="#EA4335"
)
protectli.add_task(
    "Validation", "2024-10-01", "2024-11-15", style="rounded", fill_colour="#34A853"
)
protectli.add_task(
    "DES Release", "2024-11-16", "2024-12-31", style="rounded", fill_colour="#FD7E14"
)
...
mb.add_task(
    "Porting", "2024-04-01", "2024-06-30", style="rounded", fill_colour="#EA4335"
)
mb.add_task(
    "Validation",
    "2024-07-01",
...
mb.add_task(
    "DES Release", "2024-10-01", "2024-11-15", style="rounded", fill_colour="#FD7E14"
)
...
novacustom.add_task(
    "DES Release", "2024-02-15", "2024-03-31", style="rounded", fill_colour="#FD7E14"
)
novacustom_091 = roadmap.add_group("Novacustom NV4x v0.9.1")
novacustom_091.add_task(
    "DES Release", "2024-07-01", "2024-09-30", style="rounded", fill_colour="#FD7E14"
)
novacustom_180 = roadmap.add_group("Novacustom NV4x v1.7.2.x")
novacustom_180.add_task(
    "DES Release", "2024-10-01", "2024-12-31", style="rounded", fill_colour="#FD7E14"
)
...
lenovo.add_task(
    "Porting", "2024-02-15", "2024-03-31", style="rounded", fill_colour="#EA4335"
)
lenovo.add_task(
    "Validation", "2024-04-01", "2024-06-30", style="rounded", fill_colour="#34A853"
)
lenovo.add_task(
    "DES Release", "2024-07-01", "2024-09-30", style="rounded", fill_colour="#FD7E14"
)
...
dell_optiplex.add_task(
    "DES Release", "2024-08-16", "2024-09-30", style="rounded", fill_colour="#FD7E14"
)
...
msi_z690.add_task(
    "DES Release", "2024-01-01", "2024-03-31", style="rounded", fill_colour="#FD7E14"
)
...
rcs.add_task(
    "DES Release", "2024-05-16", "2024-06-30", style="rounded", fill_colour="#FD7E14"
)
