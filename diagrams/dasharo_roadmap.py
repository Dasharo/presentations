...
msi_z690.add_task("Validation", "2024-01-01", "2023-02-14", style="rounded", fill_colour="#34A853", font_size=23)
...
roadmap.set_footer(f"Dasharo Community Support Roadmap | {date} ({version}) | CC-BY-SA-4.0")
roadmap.draw()
roadmap.save(f"img/dcs_desktop_msi_z790_heads_roadmap_{version}.png")
