...
dts_1213.add_task(
    "Porting", "2024-01-01", "2024-02-14", style="rounded", fill_colour="#EA4335"
)
dts_1213.add_task(
    "Validation", "2024-02-15", "2024-03-06", style="rounded", fill_colour="#34A853"
)
dts_1213.add_task(
    "Community Release",
    "2024-03-07",
...
dts_200.add_task(
    "Porting", "2024-01-01", "2024-03-31", style="rounded", fill_colour="#EA4335"
)
dts_200.add_task(
    "Validation", "2024-04-01", "2024-05-15", style="rounded", fill_colour="#34A853"
)
dts_200.add_task(
    "Community Release",
    "2024-05-16",
